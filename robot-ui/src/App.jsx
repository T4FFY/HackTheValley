...
const BlocklyRobotController = () => {
  ...
  useEffect(() => {
    ...
    const initializeBlockly = async () => {
      try {
        await loadScript('https://cdnjs.cloudflare.com/ajax/libs/blockly/10.4.3/blockly.min.js');
        await loadScript('https://cdnjs.cloudflare.com/ajax/libs/blockly/10.4.3/blocks.min.js');
        await loadScript('https://cdnjs.cloudflare.com/ajax/libs/blockly/10.4.3/javascript.min.js');
  ...
  const initBlockly = () => {
    ...
    window.Blockly.Blocks['robot_oled'] = {
      init: function() {
        this.appendDummyInput()
            .appendField("📺 Display:")
            .appendField(new window.Blockly.FieldTextInput("Hello Robot!"), "MESSAGE");
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
    ...
    <div className="app-container">
      <div className="app-content">
        ...
        <div className="header">
          ...
          <p className="header-subtitle">Build your robot's brain with code blocks! 🧠✨</p>
        </div>
                ...
                {!loaded && (
                  <div className="loading-container">
                    <div className="loading-content">
                      ...
                      <p className="loading-text">Loading your coding playground...</p>
                    </div>
                  </div>
                )}
                <div 
                  ref={blocklyDiv} 
                  style={{ height: '600px', width: '100%', display: loaded ? 'block' : 'none' }}
                />
              </div>
